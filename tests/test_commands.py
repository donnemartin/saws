...
from iawscli.commands import generate_all_commands, COMMANDS_HEADER, \
    SUB_COMMANDS_HEADER, GLOBAL_OPTIONS_HEADER, SOURCES_PATH


class CommandsTest(unittest.TestCase):

    def test_generate_all_commands(self):
        commands, sub_commands, global_options = generate_all_commands()
        num_commands = 0
        num_sub_commands = 0
        ...
        with open(SOURCES_PATH) as f:
            for line in f:
                ...
                if COMMANDS_HEADER in line:
                    ...
                    num_global_options = int(line.strip(GLOBAL_OPTIONS_HEADER))
